      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            //var minSrc = 'https://raw.githubusercontent.com/marmellata77/blog_album/master/min_photos' + data.link[i];
            var minSrc = 'https://raw.githubusercontent.com/marmellata77/blog_album/master/min_photos/' + data.link[i];
			
           // var src = 'https://raw.githubusercontent.com/marmellata77/blog_album/master/photos/' + data.link[i];
            var src = 'https://raw.githubusercontent.com/marmellata77/blog_album/master/photos' + data.link[i];
